    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark p-3">
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav mr-auto my-2 my-lg-0 navbar-nav-scroll">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="http://localhost/patient-management-system/department.php">Department</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost/patient-management-system/designation.php">Designation</a>
                </li>
            </ul>
    ...
    <script>
        ...
        function deleteDepartment(id) {
            if (confirm("Do you want to delete this department?")) {
                window.location = "http://localhost/patient-management-system/endpoint/delete-department.php?department=" + id;
            }
        }
